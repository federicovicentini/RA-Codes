...
ggplot(n4aggcr, aes(x = fyear, color = naics2)) +
  ...
  labs(x = "Year", y = "CR4", title = "Time Series of CR4 by Sector (aggregation by Naics 4)", linetype = "") +
...
ggplot(n4aggcr, aes(x = fyear, color = naics2)) +
  ...
  facet_wrap(~ naics2, scales = "free_y") +
  labs(x = "Year", y = "CR20", title = "Time Series of CR20 by Sector (aggregation by Naics 4)", linetype = "") +
  scale_linetype_manual(values = c("solid", "dotted"), labels = c("Sales", "Employment")) +
  theme_minimal() +
  guides(color = "none")
