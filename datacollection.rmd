...
This is precisely why I tried to replicate the laborshare measure provided by {@guerriero2019}, defined as:
...
For laac of available data on the structure of the labor force in the US
...
ts$mult=mergemp$mult

ts$labshare=(ts$wages)/(ts$gdp-ts$ind_tax-ts$fcc)
...
### Labor Share from Autor er al.

Another attempt at constructing a measure of the labor share of output comes 
from Autor er al.(@autor2020)
